...
public final class BookContract {
    ...
    static final String CONTENT_AUTHORITY = "com.example.akl.inventoryapp";
    ...
    public static abstract class BookEntry implements BaseColumns{
        ...
        static final String BOOK_COLUMN_IMAGE = "product_image";
        ...
        static final String CONTENT_LIST_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY +"/" + PATH_ITEMS;
        static final String Content_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_ITEMS;
    }
}
